...
On the diagram this is a story of four levels: the metal's $V_{\mathrm{e}^-}$ and the reaction's $V_{\mathrm{e}^-}$ (sitting one on top of the other), the reaction's standard level $V^\circ_{\mathrm{e}^-}(\mathrm{Ox}/\mathrm{Red})$, and the reference $V^\circ_{\mathrm{e}^-}(\mathrm{SHE})$. $E$ is just one marked vertical distance among them.
