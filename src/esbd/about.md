...
The electron half of this outlook did escape into the world at the time, though. In 2013, under my Wikipedia handle [Nanite](https://en.wikipedia.org/wiki/User:Nanite), I went on a "the Fermi level is supreme" kick: I drew a pile of diagrams, and spread the word that voltmeters measure $\bar\mu_{\mathrm{e}^-}$ (and my edits stand largely unchanged to this day). [Species voltage](../v_i/) $V_i$ is the same opinionated move made a dozen years later, this time bringing the ions along. (And, a shout out to Steve Byrnes, who was also active [on wikipedia](https://en.wikipedia.org/wiki/User:Sbyrnes321) around then doing Fermi level things.^[Steve's website has the wonderful [Translation guide for discussing electron energy concepts](https://sjbyrnes.com/fermiterminology.html), written circa 2011.])
...
So once again I got to wondering how do batteries work (from a solid state physicist point of view). So I bothered the Deepseek R1 LLM with various novice questions, and at some point I came up with $-\bar\mu_i/z_i$ scaling again and asked if that would make a decent band diagram for electrochemical systems. This time the idea stuck.
...
First of all, **band diagrams for electrochemistry exist, just not like this**. The Gerischer / Reiss lineage^[Gerischer, H. (1960–61). [Über den Ablauf von Redoxreaktionen an Metallen und an Halbleitern, I–III.](https://doi.org/10.1524/zpch.1960.26.3_4.223) Z. Phys. Chem. NF, 26, 223–247 & 325–338; 27, 48–79. Reiss, H. (1985). [The Fermi level and the redox potential.](https://doi.org/10.1021/j100264a005) J. Phys. Chem. 89(18), 3783–3791.] is the closest thing, matching the redox band diagrams in the [half](../half/), [e](../e/), [kinetics](../kinetics/) topics, just plotted as energy band diagrams rather than voltage (but, conveying very much the same ideas). This tradition continues today, most prominently in Juan Bisquert's energy diagrams of semiconductor/electrolyte junctions.^[J. Bisquert, P. Cendula, L. Bertoluzzi, and S. Gimenez, [Energy Diagram of Semiconductor/Electrolyte Junctions](https://doi.org/10.1021/jz402703d), *J. Phys. Chem. Lett.* **5**, 205 (2014).] There are also other things called "electrochemical band diagrams", which unfortunately tend to embed a reliance on vacuum-matching assumptions, which [are not a reliable foundation](../vacuum/).^[2014 Roqueta & Santiso ["Band diagrams for electrochemical devices"](https://dx.doi.org/10.13140/2.1.5078.2726) and 2018 Young et al. ["Unified Electrochemical Band Diagram"](https://doi.org/10.1002/adfm.201803439)]

Second, the idea of **scaling ionic electrochemical potentials into voltages is not new** either! This is the territory of Ilan Riess, ranging from his classic work about Fermi levels^[Riess, I. ["What does a voltmeter measure?."](https://doi.org/10.1016/S0167-2738(96)00542-5) Solid State Ionics 95.3-4 (1997): 327-328.] to later works about ionic electrochemical potentials.^[Riess, I. ["Mixed ionic–electronic conductors—material properties and applications."](https://doi.org/10.1016/S0167-2738(02)00182-0) Solid State Ionics 157.1-4 (2003): 1-17.] Note that Riess focuses on differences and doesn't seem to promote the 'global covariant voltage scale' view but it's basically equivalent in the end. The $V_i = \bar\mu_i / q_i$ concept was put into excellent practice by Jamnik and Maier, dating back to 1999^[J. Jamnik and J. Maier, [Treatment of the impedance of mixed conductors](https://doi.org/10.1149/1.1392611), *J. Electrochem. Soc.* **146**, 4183 (1999).] in an equivalent circuit view of ionic materials, a viewpoint that survives to this day in that community (e.g. recent works of Fleig group at TU Wien^[A. E. Bumberger, A. Nenning, and J. Fleig, [Transmission line revisited](https://doi.org/10.1039/d4cp00975d), *Phys. Chem. Chem. Phys.* **26**, 15068 (2024).]). Battery modeling has been closer still, without saying so: the electrolyte potential $\Phi_2$ of Newman's porous-electrode theory is defined by a hypothetical lithium reference electrode inserted in the electrolyte, which makes it exactly our $V_{\mathrm{e}^-}(\mathrm{Li}^+/\mathrm{Li}^0)$, tracking $V_{\mathrm{Li}^+}$ at a constant offset. The field has been simulating a species voltage all along; it just never drew the rest of the ladder. Jamnik and Maier by the way also introduced the wonderful 'displacement rail' picture in 2001,^[J. Jamnik and J. Maier, [Generalised equivalent circuits for mass and charge transport](https://doi.org/10.1039/b100180i), *Phys. Chem. Chem. Phys.* **3**, 1668 (2001).] which closely relates to the views in the [basic electrostatics](../basicelectrostatics/) and [chemical capacitance matrices](../chemical_capacitance_matrices/) topics.

So what is actually new?
* The idea of ***plotting* all $V_i$ together** (not just electronic but ionic too) strangely has not been done before. For me this is what makes it all worth it, having that visual. Again, it's all about what Kroemer said, that you need a visual to explain things.^[[H. Kroemer (2000). Nobel Lecture.](https://www.nobelprize.org/uploads/2018/06/kroemer-lecture.pdf)] Note that it's the $V_i$ that go on the plot, not the raw electrochemical potentials $\bar\mu_i$: under a shift in $\phi$ the $\bar\mu_i$ [scatter in different directions](../muintro/#ions-are-weird), which makes them awkward to compare with each other, while the $V_i$ move in unison.
* The **floating standard state $V^\circ_i$ ladder** as 'ionic band edges' seems entirely new. To scope this claim precisely: reasoning from band edges instead of $\phi$ is standard semiconductor discipline (Kroemer again), and single-ion band edges have been drawn before, in the solid state ionics literature.^[For example, Maier's ionic level diagrams draw the interstitial and vacancy levels of a mobile ion (their standard electrochemical potentials) as ionic conduction and valence band edges, bending through space charge zones like semiconductor bands, next to the electronic band diagram: an isomorphism between ions and electrons, one species at a time, on an energy axis. The vacancy level $-\tilde\mu^\circ_\mathrm{v}$ is in fact the $z=-1$ case of our normalization. J. Maier, [Ionic and electronic carriers in solids—physical and chemical views of the equilibrium situation](https://doi.org/10.1016/S0167-2738(01)00828-1), *Solid State Ionics* **143**, 17 (2001); J. Maier, [Ionic conduction in space charge regions](https://doi.org/10.1016/0079-6786(95)00004-E), *Prog. Solid State Chem.* **23**, 171 (1995).] The new part is dividing by $q_i$, so that the standard states of *all* the species form one rigid ladder that floats together. That is what lets the same discipline port into solution electrochemistry, where $\phi$-thinking still dominates. Nor is the ladder secretly $\phi$ wearing activity conventions: it spends strictly fewer of the arbitrary choices that poison comparisons ([Offsets galore](../offsetsgalore/) keeps score), and in fact semiconductor practice makes the same move, aligning bands via levels like branch-point energies rather than via $\phi$. The technical payoff is that you focus on 'what the ion feels', a distinction that matters when you look at interfaces between different solvents. And, the $V^\circ_i$ (and $\phi$) offset ambiguity thing is, I think, a nice visual picture to explain the origin of nonideality ([nonideality topic](../nonideal/)).
* A few more things, like [the proper treatment of multicarrier capacitance as matrices](../chemical_capacitance_matrices/), and I think a [more precise description of redox levels](../half/), are technical improvements as well.
...
So then, I should have named it "species potential", or maybe "electrochemical potential potential" (just kidding on that one)?
