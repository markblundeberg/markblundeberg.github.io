...
* The quantitative $V_i - V_j$ values that we plot depend on a (global) chemical convention per element. I've chosen the nearly universal convention that chemical potentials equal Gibbs formation energies.
